...
本博客基于开源主题 [Asterris](https://github.com/yCENzh/Fuwari-yCENzh)（[Fuwari](https://github.com/saicaca/fuwari) 的 Astro 移植版）构建，主题使用 MIT 协议开源，原版主题由 [saicaca](https://github.com/saicaca) 开发。
